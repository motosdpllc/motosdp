...
// ESTA FUNCION FALTABA EXPORTARSE O ESTABA FUERA DE SCOPE
      ...
      <html>
        ...
        <body>
          ...
          <div class="header-info">
            <strong>Cliente:</strong> ${clientes?.nombre || 'No definido'}<br/>
            <strong>Teléfono:</strong> ${clientes?.telefono || 'No disponible'}
          </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="bg-gray-500 text-white rounded hover:bg-gray-600 font-semibold"
          >
            ← Volver
          </button>
        </div>
