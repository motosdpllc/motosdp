...
function NuevoForm() {
  ...
  const [editIdState, setEditId] = useState<string | null>(null) // Renombrado para evitar conflicto
  ...
  const guardar = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Las ubicaciones físicas son: 'Proveedor','En tránsito','En tránsito a Daniel','Daniel','Pablo','Blue Mail','Tato','Tránsito a Bs As','Stock EEUU', 'Stock España', 'Stock Argentina'
      // Si destino es 'Vendido' Y la ubicacion NO es una de las de stock físico (En Mano, Stock...), entonces es pendiente.
      const isPendienteCompra = tipoCarga === 'Venta' && ['Proveedor', 'En tránsito', 'En tránsito a Daniel', 'Daniel', 'Pablo', 'Blue Mail', 'Tato', 'Tránsito a Bs As'].includes(f.ubicacion);
          ...
          <form onSubmit={guardar}>
            ...
            {!editId && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <SelectorCotizacion cotizaciones={cotizaciones} setF={setF} setCliSearch={setCliSearch} cotDropRef={cotDropRef} /> {/* Pasa las props necesarias */}
