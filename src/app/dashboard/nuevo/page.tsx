...
function NuevoForm() {
  ...
  const guardar = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Es pendiente_compra si es una VENTA y NO LO TENGO (no está en ninguna ubicación de posesión)
      const isPendienteCompra = tipoCarga === 'Venta' && (f.ubicacion === 'Proveedor' || f.ubicacion.startsWith('En tránsito'));
